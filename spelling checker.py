from textblob import TextBlob               #textblob is a module used for correcting the spelling
from tkinter import *               # tkinter used for making the window
...
def main_window():
    ...
    win=Tk()
    win.geometry("500x370")          #width x height
